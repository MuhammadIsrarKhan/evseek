    ...
    >
      ...
      <div className="h-full md:flex md:flex-row md:gap-4 md:justify-center md:mt-14">
        ...
        <div
          // data-aos="fade-up"
          // data-aos-duration="1500"
          className="h-[25%] Grow-cards w-[75vw] md:w-[33%] md:h-[60vh]  lg:w-[350px] lg:h-[483px] bg-[#F4F5F4] mt-10 rounded-lg flex flex-col  items-center relative"
        >
          ...
          <button className="text-[#12141D] hover:animate-wiggle font-bold text-xs md:text-base font-jost leading-5 bg-[#FFFFFF] w-[60vw] md:w-[200px] lg:w-[280px] h-[60px] rounded absolute bottom-4 md:bottom-16">
        ...
        <div
          // data-aos="fade-up"
          // data-aos-duration="1500"
          className="h-[25%] w-[75vw] Grow-cards  md:w-[33%] md:h-[65vh]  lg:w-[350px] lg:h-[520px] md:shadow bg-[#0F2A0F] mt-[8%] md:mt-0 rounded-lg flex flex-col items-center relative"
        >
          ...
          <button className="hover:animate-wiggle font-bold text-xs md:text-base font-jost leading-5 bg-[#21D57C] text-[#FFFFFF] w-[60vw] rounded absolute bottom-4 lg:w-[280px] h-[60px] md:bottom-16 md:w-[200px]">
            Start 14 Days Free Trial
          </button>
        </div>
        {/* 3 */}
        <div
          // data-aos="fade-up"
          // data-aos-duration="1500"
          className="h-[25%] Grow w-[75vw] Grow-cards  md:w-[33%] md:h-[60vh]  lg:w-[350px] lg:h-[483px] bg-[#F4F5F4] mt-10 rounded-lg flex flex-col items-center relative"
        >
          <p className="font-inter font-bold text-xs mt-[8%] md:mt-[36px]">
            PREMIUM
          </p>
          ...
          <button className="text-[#12141D] hover:animate-wiggle font-bold text-xs font-jost leading-5 bg-[#FFFFFF] w-[60vw] rounded absolute bottom-4 lg:w-[280px] h-[60px] md:text-base md:bottom-16 md:w-[200px]">
            Start 14 Days Free Trial
          </button>
        </div>
      </div>
